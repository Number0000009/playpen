...
; Load palette
	...
	move.l #120,d6						; iters
	moveq #20,d5						; lines per block

	move.l screen_ptr,d4
	addi.l #(200-20)*160,d4				; src

	move.l screen_ptr,d3
	addi.l #(100*160),d3
...
; if dst_addr < screen_ptr -> decr d5, src_addr + (1*160)
	move.l screen_ptr,d0
	move.l dst_addr,d1
	addi.l #1*160,d0
	cmp.l d0,d1
	...
	subi.l #1,d5						; 1 less line per block
	bne skip1
